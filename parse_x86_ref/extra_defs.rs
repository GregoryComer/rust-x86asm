...
InstructionDefinition { 
    ...
    can_lock: false, fixed_prefix: Some(0xF3), flags: InstructionDefinitionFlags { mem_format: None, tttn: None }, force_addr_size_prefix: false, has_destination: true, opcode_ext: None, proc_end: None, ring_level: RingLevel::Ring3, valid_in_long_mode: true, op_size_64_behavior: OpSize64Behavior::Normal },
    // RET
    InstructionDefinition { mnemonic: Mnemonic::RET, fixed_prefix: None, is_two_byte_opcode: false, primary_opcode: 194, secondary_opcode: None, flags: InstructionDefinitionFlags { tttn: None, mem_format: None }, opcode_ext: None, has_destination: false, proc_start: None, proc_end: None, mode: Mode::Real, ring_level: RingLevel::Ring3, can_lock: false, valid_in_long_mode: true, force_op_size_prefix: false, force_addr_size_prefix: false, op_size_64_behavior: OpSize64Behavior::Normal, force_vex: false, force_evex: false, vector_size: None, allow_rounding_mode: false, allow_sae: false, allowed_broadcast: None, operand2: None, operand3: None, operand4: None, operand1: Some(OperandDescription { addressing_mode: OperandAddressingMode::I, operand_type: OperandType::W, fixed_operand: None }) },
    InstructionDefinition { mnemonic: Mnemonic::RET, fixed_prefix: None, is_two_byte_opcode: false, primary_opcode: 195, secondary_opcode: None, flags: InstructionDefinitionFlags { tttn: None, mem_format: None }, opcode_ext: None, has_destination: true, proc_start: None, proc_end: None, mode: Mode::Real, ring_level: RingLevel::Ring3, can_lock: false, valid_in_long_mode: true, force_op_size_prefix: false, force_addr_size_prefix: false, op_size_64_behavior: OpSize64Behavior::Normal, force_vex: false, force_evex: false, vector_size: None, allow_rounding_mode: false, allow_sae: false, allowed_broadcast: None, operand2: None, operand3: None, operand4: None, operand1: None },
