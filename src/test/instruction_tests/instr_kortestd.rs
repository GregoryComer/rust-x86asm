...
#[test]
fn kortestd_2() {
    run_test(&Instruction { mnemonic: Mnemonic::KORTESTD, operand1: Some(Direct(K4)), operand2: Some(Direct(K7)), operand3: None, operand4: None, lock: false, rounding_mode: None, merge_mode: None, sae: false, mask: None, broadcast: None }, &[196, 225, 249, 152, 231], OperandSize::Qword)
}
