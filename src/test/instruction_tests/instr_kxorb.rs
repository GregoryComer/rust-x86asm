...
#[test]
fn kxorb_1() {
    run_test(&Instruction { mnemonic: Mnemonic::KXORB, operand1: Some(Direct(K7)), operand2: Some(Direct(K7)), operand3: Some(Direct(K3)), operand4: None, lock: false, rounding_mode: None, merge_mode: None, sae: false, mask: None, broadcast: None }, &[197, 197, 71, 251], OperandSize::Dword)
}
