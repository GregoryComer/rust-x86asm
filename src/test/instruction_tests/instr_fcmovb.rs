...
#[test]
fn fcmovb_1() {
    run_test(&Instruction { mnemonic: Mnemonic::FCMOVB, operand1: Some(Direct(ST)), operand2: Some(Direct(ST2)), operand3: None, operand4: None, lock: false, rounding_mode: None, merge_mode: None, sae: false, mask: None, broadcast: None }, &[218, 194], OperandSize::Word)
}
