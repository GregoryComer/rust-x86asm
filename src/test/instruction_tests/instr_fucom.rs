...
#[test]
fn fucom_3() {
    run_test(&Instruction { mnemonic: Mnemonic::FUCOM, operand1: Some(Direct(ST2)), operand2: None, operand3: None, operand4: None, lock: false, rounding_mode: None, merge_mode: None, sae: false, mask: None, broadcast: None }, &[221, 226], OperandSize::Qword)
}
